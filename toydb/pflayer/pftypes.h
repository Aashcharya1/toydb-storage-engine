...
extern int PFbufGet(int fd,int pagenum,PFfpage **fpage,int (*readfcn)(),int (*writefcn)(),PFReplacementPolicy policy);
extern int PFbufUnfix(int fd,int pagenum,int dirty);
extern int PFbufAlloc(int fd,int pagenum,PFfpage **fpage,int (*writefcn)(),PFReplacementPolicy policy);
extern int PFbufReleaseFile(int fd,int (*writefcn)());
extern int PFbufUsed(int fd,int pagenum);
extern void PFbufSetCapacity(int numBufs);
